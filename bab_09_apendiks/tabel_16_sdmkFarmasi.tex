...
\begin{tabular}{rlZ{3em}Z{3em}Z{3em}Z{3em}Z{3em}Z{3em}Z{3em}Z{3em}Z{3em}}
    ...
    \toprule
    \multirow{3}{*}{NO} & \multirow{3}{*}{UNIT KERJA} & \multicolumn{3}{X{12em}}{TENAGA KEFARMASIAN} & \multicolumn{3}{c}{APOTEKER} & \multicolumn{3}{X{11em}}{TENAGA KESEHATAN TRADISIONAL} \\
