...
berkasData = currentdir +'\\bab_05_28_dataSkriningProduktif_b.csv'
berkasSimpan = currentdir +'\\bab_05_28_skriningProduktif_b.pdf'
# judulDiagram = 'Penemuan Resiko PTM Usia Produktif\nTahun 2021'
sumbuX = 'Cakupan'
