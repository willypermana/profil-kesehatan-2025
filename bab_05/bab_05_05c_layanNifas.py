...
berkasData = currentdir +'\\bab_05_05c_dataLayanNifas.csv'
...
# read data file
colnames = ['puskesmas','KF1','KFlengkap']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.KF1.tolist()
bar2 = data.KFlengkap.tolist()
...
# make bars
fig, ax = plt.subplots()
rects1 = ax.barh(ind, bar1, width, color='steelblue', label = 'KF 1')
rects2 = ax.barh(ind + width, bar2, width, color='orangered', label = 'KF Lengkap')
