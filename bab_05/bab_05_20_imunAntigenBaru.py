...
berkasData = currentdir +'\\bab_05_20_dataImunAntigenBaru.csv'
berkasSimpan = currentdir +'\\bab_05_20_imunAntigenBaru.pdf'
...
# read data file
colnames = ['puskesmas','imunAntigenBaruL','imunAntigenBaruP', 'imunAntigenBaruLP']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.imunAntigenBaruL.tolist()
bar2 = data.imunAntigenBaruP.tolist()
bar3 = data.imunAntigenBaruLP.tolist()
