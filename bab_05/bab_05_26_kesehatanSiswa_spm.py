...
berkasData = currentdir +'\\bab_05_26_dataKesehatanSiswa_spm.csv'
berkasSimpan = currentdir +'\\bab_05_26_kesehatanSiswa_spm.pdf'
# judulDiagram = 'Cakupan Pelayanan Usia Pendidikan Dasar\nTahun 2021'
sumbuX = 'Cakupan'
sumbuY = 'Puskesmas\ Kabupaten'
tickerSumbuX = np.arange(0,110,25)
labelBar1 = 'Pelayanan Usia Dikdas'

# read data file
colnames = ['puskesmas','dikdas']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.dikdas.tolist()
