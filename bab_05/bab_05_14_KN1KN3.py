...
berkasData = currentdir +'\\bab_05_14_dataKN1KN3.csv'
berkasSimpan = currentdir +'\\bab_05_14_KN1KN3.pdf'
...
for i, v in enumerate(bar2):
    ax.text(v+0.5, i+0.3, locale.format_string("%.2f", v), ha='left', va='center', fontsize='x-small')
