...
berkasData = currentdir +'\\bab_05_19_dataImunBayiLengkap.csv'
berkasSimpan = currentdir +'\\bab_05_19_ImunBayiLengkap.pdf'
# judulDiagram = 'Cakupan Imunisasi HB0\nTahun 2021'
sumbuX = 'Cakupan'
...
# read data file
colnames = ['puskesmas','imunBayiLengkapL','imunBayiLengkapP', 'imunBayiLengkapLP']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.imunBayiLengkapL.tolist()
bar2 = data.imunBayiLengkapP.tolist()
bar3 = data.imunBayiLengkapLP.tolist()
