...
berkasData = currentdir +'\\bab_05_29b_dataCatinResiko.csv'
berkasSimpan = currentdir +'\\bab_05_29b_catinResiko.pdf'
# judulDiagram = 'Cakupan Inisiasi Menyusui Dini & ASI Eksklusif\nTahun 2021'
sumbuX = 'Cakupan'
sumbuY = 'Puskesmas/ Kabupaten'
labelBar1 = 'Catin Perempuan Anemia'
labelBar2 = 'Catin Perempuan Gizi Kurang'
tickerSumbuX = np.arange(0,110,25)

# read data file
colnames = ['puskesmas','catinAnemia','catinGiziKurang']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.catinAnemia.tolist()
bar2 = data.catinGiziKurang.tolist()
