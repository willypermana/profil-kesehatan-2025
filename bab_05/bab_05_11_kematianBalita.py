...
berkasData = currentdir +'\\bab_05_11_dataKematianBalita.csv'
berkasSimpan = currentdir +'\\bab_05_11_kematianBalita.pdf'
...
bar1 = data.balitaL.tolist()
bar2 = data.balitaP.tolist()
bar3 = data.balitaLP.tolist()
