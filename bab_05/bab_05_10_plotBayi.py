...
berkasData = currentdir + '\\bab_05_10_dataPlotBayi.csv'
berkasSimpan = currentdir + '\\bab_05_10_plotBayi.pdf'
# judulDiagram = 'Angka Kematian Bayi\nTahun 2021'
sumbuX = 'Tahun'
sumbuY = 'per 1.000 kelahiran'
tickerSumbuY = np.arange(0,26,5)

# read data file
colnames = ['tahun','akbLP']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
tahun = data.tahun.tolist()
dataLP = data.akbLP.tolist()
...
# make plots
fig, ax = plt.subplots()
garis3 = ax.plot(ind, dataLP, marker='.', color='yellowgreen', label='AKB')
