...
berkasData = currentdir +'\\bab_05_27c_dataSDpelayananGigi.csv'
berkasSimpan = currentdir +'\\bab_05_27c_SDpelayananGigi.pdf'
sumbuX = 'Cakupan'
sumbuY = 'Puskesmas/ Kabupaten'
labelBar1 = 'SD mendapat pelayanan gigi'
tickerSumbuX = np.arange(0,110,25)

# read data file
colnames = ['puskesmas','SDpelayananGigi']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.SDpelayananGigi.tolist()
