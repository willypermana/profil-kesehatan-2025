...
berkasData = currentdir +'\\bab_05_05d_dataNifasVitA.csv'
berkasSimpan = currentdir +'\\bab_05_05d_nifasVitA.pdf'
# judulDiagram = 'Cakupan Ibu Nifas Mendapat Vit. A\nTahun 2021'
sumbuX = 'Cakupan'
sumbuY = 'Puskesmas/ Kabupaten'
tickerSumbuX = np.arange(0,110,25)

# read data file
colnames = ['puskesmas','nifasVitA']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.nifasVitA.tolist()
...
# make bars
fig, ax = plt.subplots()
rects1 = ax.barh(ind, bar1, width, color='steelblue', label = 'Ibu Nifas Mendapat Vit. A')
