...
berkasData = currentdir +'\\bab_05_27d_dataGimulSDdirawat.csv'
...
labelBar1 = 'Murid SD/ MI mendapat perawatan gigi setelah pemeriksaan'
tickerSumbuX = np.arange(0,110,25)

# read data file
colnames = ['puskesmas','gimulSDdirawat']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.gimulSDdirawat.tolist()
