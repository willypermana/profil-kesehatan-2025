...
berkasData = currentdir +'\\bab_05_20_dataImunCampakIDL.csv'
berkasSimpan = currentdir +'\\bab_05_20b_imunIDL.pdf'
...
# read data file
colnames = ['puskesmas','campakL','campakP','campakLP','idlL','idlP','idlLP']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.campakL.tolist()
bar2 = data.campakP.tolist()
bar3 = data.campakLP.tolist()
bar4 = data.idlL.tolist()
bar5 = data.idlP.tolist()
bar6 = data.idlLP.tolist()
