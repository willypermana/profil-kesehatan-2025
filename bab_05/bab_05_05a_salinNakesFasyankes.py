...
berkasData = currentdir +'\\bab_05_05a_dataSalinNakesFasyankes.csv'
berkasSimpan = currentdir +'\\bab_05_05a_salinNakesFasyankes.pdf'
...
# read data file
colnames = ['puskesmas','salinNakes','salinYankes']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.salinNakes.tolist()
bar2 = data.salinYankes.tolist()
...
# make bars
fig, ax = plt.subplots()
rects1 = ax.barh(ind, bar1, width, color='steelblue', label='Persalinan ditolong Nakes terlatih')
rects2 = ax.barh(ind + width, bar2, width, color='orangered', label = 'Persalinan di Fasyankes')
