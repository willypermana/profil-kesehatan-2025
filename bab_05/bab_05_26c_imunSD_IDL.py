...
berkasData = currentdir +'\\bab_05_26c_dataImunSD_HPV_IDL.csv'
berkasSimpan = currentdir +'\\bab_05_26c_imunSD_IDL.pdf'
...
# read data file
colnames = ['puskesmas','HPV_SD','idlSD_L','idlSD_P','idlSD_LP']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.HPV_SD.tolist()
bar2 = data.idlSD_L.tolist()
bar3 = data.idlSD_P.tolist()
bar4 = data.idlSD_LP.tolist()
...
# make bars
fig, ax = plt.subplots()
rects1 = ax.barh(ind, bar2, width, color='steelblue', label=labelRects1)
rects2 = ax.barh(ind + width, bar3, width, color='orangered', label = labelRects2)
rects3 = ax.barh(ind + 2*width, bar4, width, color='yellowgreen', label = labelRects3)
