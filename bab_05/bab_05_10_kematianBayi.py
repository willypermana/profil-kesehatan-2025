...
berkasData = currentdir +'\\bab_05_10_dataKematianBayi.csv'
berkasSimpan = currentdir +'\\bab_05_10_kematianBayi.pdf'
# judulDiagram = 'Jumlah Kematian Bayi\nTahun 2021'
sumbuX = 'Jumlah'
sumbuY = 'Puskesmas\ Kabupaten'
tickerSumbuX = np.arange(0,41,10)

# read data file
colnames = ['kecamatan','bayiL','bayiP','bayiLP']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
kecamatan = data.kecamatan.tolist()
bar1 = data.bayiL.tolist()
bar2 = data.bayiP.tolist()
bar3 = data.bayiLP.tolist()
