...
berkasSimpan = currentdir +'\\bab_05_26c_imunSD_HPV.pdf'
...
# make bars
fig, ax = plt.subplots()
rects1 = ax.barh(ind, bar1, width, color='steelblue', label = 'HPV')
...
ax.set_yticks(ind)
ax.set_yticklabels(list([ '\n'.join(wrap(l, 10)) for l in puskesmas ]), fontsize='small')
