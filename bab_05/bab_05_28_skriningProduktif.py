...
berkasData = currentdir +'\\bab_05_28_dataSkriningProduktif.csv'
berkasSimpan = currentdir +'\\bab_05_28_skriningProduktif.pdf'
# judulDiagram = 'Pelayanan Skrining Kesehatan Usia Produktif\nTahun 2021'
sumbuX = 'Cakupan'
sumbuY = 'Puskesmas/ Kabupaten'
labelBar1 = 'Skrining Usipro'
labelBar2 = 'Berisiko'
tickerSumbuX = np.arange(0,151,25)

# read data file
colnames = ['puskesmas','skriningUsipro','usiproBerisiko']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.skriningUsipro.tolist()
bar2 = data.usiproBerisiko.tolist()
