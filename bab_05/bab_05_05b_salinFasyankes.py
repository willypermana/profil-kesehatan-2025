...
berkasData = currentdir +'\\bab_05_05b_dataSalinFasyankes.csv'
...
# read data file
colnames = ['puskesmas','salinYankes']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.salinYankes.tolist()
...
# make bars
fig, ax = plt.subplots()
rects1 = ax.barh(ind, bar1, width, color='steelblue', label = 'Persalinan di Fasyankes')
