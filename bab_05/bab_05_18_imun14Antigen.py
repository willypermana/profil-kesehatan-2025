...
berkasData = currentdir +'\\bab_05_18_dataImun14Antigen.csv'
berkasSimpan = currentdir +'\\bab_05_18_dataImun14Antigen.pdf'
...
# read data file
colnames = ['puskesmas','antigen14L','antigen14P', 'antigen14LP']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.antigen14L.tolist()
bar2 = data.antigen14P.tolist()
bar3 = data.antigen14LP.tolist()
