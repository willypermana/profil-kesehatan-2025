...
berkasData = currentdir +'\\bab_07_04_dataTFUIKL.csv'
berkasSimpan = currentdir +'\\bab_07_04_TFUIKL.pdf'
# judulDiagram = 'Cakupan TFU IKL\nTahun 2022'
sumbuX = 'Cakupan'
sumbuY = 'Kecamatan/ Kabupaten'
labelBar1 = 'TFU dilakukan IKL'
tickerSumbuX = np.arange(0,110,25)

# read data file
colnames = ['kecamatan','TFU']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
kecamatan = data.kecamatan.tolist()
bar1 = data.TFU.tolist()
