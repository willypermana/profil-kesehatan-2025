...
berkasData = currentdir +'\\bab_07_01a_dataSKAMRT.csv'
berkasSimpan = currentdir +'\\bab_07_01a_SKAMRT.pdf'
# judulDiagram = 'Cakupan SKAMRT\nTahun 2023'
sumbuX = 'Cakupan'
sumbuY = 'Kecamatan\ Kabupaten'
labelBar1 = 'Sampel Air Minum Memenuhi Syarat'
tickerSumbuX = np.arange(0,110,25)

# read data file
colnames = ['kecamatan','airMinumMS']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
kecamatan = data.kecamatan.tolist()
bar1 = data.airMinumMS.tolist()
