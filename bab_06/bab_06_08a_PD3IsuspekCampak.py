...
berkasData = currentdir +'\\bab_06_08a_dataPD3IsuspekCampak.csv'
berkasSimpan = currentdir +'\\bab_06_08a_PD3IsuspekCampak.pdf'
# judulDiagram = 'Penemuan Kasus Suspek Campak\nTahun 2024'
sumbuX = 'Jumlah'
sumbuY = 'Puskesmas/ Kabupaten'
tickerSumbuX = np.arange(0,6,1)
