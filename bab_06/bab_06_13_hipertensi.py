...
berkasData = currentdir +'\\bab_06_13_dataHipertensi.csv'
berkasSimpan = currentdir +'\\bab_06_13_hipertensi.pdf'
# judulDiagram = 'Cakupan Pelayanan Hipertensi\nTahun 2021'
sumbuX = 'Cakupan'
sumbuY = 'Puskesmas/ Kabupaten'
tickerSumbuX = np.arange(0,251,50)
labelBar1 = 'L'
labelBar2 = 'P'
labelBar3 = 'L+P'
