...
berkasData = currentdir +'\\bab_06_10_dataDBD.csv'
berkasSimpan = currentdir +'\\bab_06_10_DBD.pdf'
# judulDiagram = 'Penemuan Kasus Demam Berdarah Dengue DBD\nTahun 2021'
sumbuX = 'Kasus'
sumbuY = 'Puskesmas/ Kabupaten'
tickerSumbuX = np.arange(0,121,20)
labelBar1 = 'L'
labelBar2 = 'P'
labelBar3 = 'L+P'
