...
berkasData = currentdir +'\\bab_06_01b_dataCureCompSuccRateTB.csv'
berkasSimpan = currentdir +'\\bab_06_01b_cureCompSuccRateTB.pdf'
# judulDiagram = 'Cure Rate & Success Rate TB'
sumbuX = 'Cakupan'
sumbuY = 'Puskesmas/ Kabupaten'
tickerSumbuX = np.arange(0,110,25)
labelBar1 = 'Cure Rate'
labelBar2 = 'Complete Rate'
labelBar3 = 'Success Rate'

# read data file
colnames = ['puskesmas','CureRate','CompleteRate','SuccessRate']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.CureRate.tolist()
bar2 = data.CompleteRate.tolist()
bar3 = data.SuccessRate.tolist()
