...
berkasData = currentdir +'\\bab_06_04_dataDiare.csv'
berkasSimpan = currentdir +'\\bab_06_04b_diareOralit.pdf'
# judulDiagram = 'Penemuan dan Pengobatan Diare\nTahun 2021'
sumbuX = 'Cakupan'
sumbuY = 'Puskesmas/ Kabupaten'
labelBar1 = 'Diare semua umur mendapat oralit'
labelBar2 = 'Diare balita mendapat oralit'
tickerSumbuX = np.arange(0,110,25)

# read data file
colnames = ['puskesmas','diareSU','diareBalita','oralitSU', 'oralitBalita', 'zincBalita']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.oralitSU.tolist()
bar2 = data.oralitBalita.tolist()
...
for i, v in enumerate(bar2):
    ax.text(v+0.5, i+width, locale.format_string("%.2f", v), ha='left', va='center', fontsize='x-small')
