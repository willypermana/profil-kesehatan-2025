...
berkasData = currentdir +'\\bab_06_06a_dataKasusBaruKusta.csv'
berkasSimpan = currentdir +'\\bab_06_06a_kasusBaruKusta.pdf'
# judulDiagram = 'Kasus Baru Kusta\nTahun 2022'
sumbuX = 'Kasus Baru'
sumbuY = 'Puskesmas/ Kabupaten'
tickerSumbuX = np.arange(0,7,2)
labelBar1 = 'Kasus Baru Kusta PB'
labelBar2 = 'Kasus Baru Kusta MB'
labelBar3 = 'Kasus Baru Kusta'

# read data file
colnames = ['puskesmas','PBbaru','MBbaru','KustaBaru']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.PBbaru.tolist()
bar2 = data.MBbaru.tolist()
bar3 = data.KustaBaru.tolist()
