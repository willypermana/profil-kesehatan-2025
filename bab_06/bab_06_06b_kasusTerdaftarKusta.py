...
berkasData = currentdir +'\\bab_06_06b_dataKasusTerdaftarKusta.csv'
berkasSimpan = currentdir +'\\bab_06_06b_kasusTerdaftarKusta.pdf'
# judulDiagram = 'Kasus Terdaftar Kusta\nTahun 2022'
sumbuX = 'Kasus Terdaftar'
sumbuY = 'Puskesmas/ Kabupaten'
tickerSumbuX = np.arange(0,7,2)
labelBar1 = 'Kasus Terdaftar Kusta PB'
labelBar2 = 'Kasus Terdaftar Kusta MB'
labelBar3 = 'Kasus Terdaftar Kusta'

# read data file
colnames = ['puskesmas','PBterdaftar','MBterdaftar','KustaTerdaftar']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.PBterdaftar.tolist()
bar2 = data.MBterdaftar.tolist()
bar3 = data.KustaTerdaftar.tolist()
