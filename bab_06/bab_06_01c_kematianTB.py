...
berkasData = currentdir +'\\bab_06_01c_dataKematianTB.csv'
berkasSimpan = currentdir +'\\bab_06_01c_kematianTB.pdf'
# judulDiagram = 'Cakupan Desa SBS\nTahun 2022'
sumbuX = 'Persentase'
sumbuY = 'Puskesmas/ Kabupaten'
labelBar1 = 'Kematian selama pengobatan TB'
tickerSumbuX = np.arange(0,110,25)

# read data file
colnames = ['puskesmas','kematianTB']
data = pandas.read_csv(berkasData, names=colnames, sep=';')
puskesmas = data.puskesmas.tolist()
bar1 = data.kematianTB.tolist()
