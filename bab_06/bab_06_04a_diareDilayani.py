...
berkasSimpan = currentdir +'\\bab_06_04a_diareDilayani.pdf'
# judulDiagram = 'Penemuan dan Pengobatan Diare\nTahun 2021'
sumbuX = 'Cakupan'
sumbuY = 'Puskesmas/ Kabupaten'
labelBar1 = 'Penemuan Diare Semua Umur'
labelBar2 = 'Penemuan Diare Balita'
...
bar1 = data.diareSU.tolist()
bar2 = data.diareBalita.tolist()
