...
explodeTuple = (0.07, 0.07, 0.02, 0.07, 0.11, 0.02, 0.07)
patches, texts, autotexts = ax1.pie(listJumlah[0:7], autopct='%.2f%%', pctdistance=1.18, explode=explodeTuple, startangle=90, counterclock=False)
